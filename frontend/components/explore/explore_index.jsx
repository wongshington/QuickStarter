    ...
    <li></li>
      ...
      <h3>Categories</h3>
        <ul>
          ...
          <Link to="/categories/4" ><li>{categories[4].name}<span>{categories[4].project_count}</span></li></Link>
          <Link to="/categories/5" ><li>{categories[5].name}<span>{categories[5].project_count}</span></li></Link>
          <Link to="/categories/6" ><li>{categories[6].name}<span>{categories[6].project_count}</span></li></Link>
        </ul>
    </div>
);
