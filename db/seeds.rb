...
ActiveRecord::Base.transaction do
  ...
  project1= Project.new(
    ...
    funding_goal: 5410, 
    funding_deadline: '2020-08-05', 
    blurb: "Dogs Deserve A Doggone Good Time! Come find out how to support the cause with us!",
  ...
  project2= Project.new(
    ...
    blurb: "Money In Your Wallet and Mine! Help me help you help me! Together we'll unlock the secrets to personal wealth for me and maybe for you!",
  ...
  project3= Project.new(
    ...
    blurb: "The Future of Art is in Diapers! We're going to see the best babies and most talented toddlers rise to the occasion with your help!",
  ...
  project4= Project.new(
    ...
    blurb: "I've been thinking about this chicken. And I think she's been thinking about me! Let's talk about it to make sure I'm not crazy.",
    ...
    backer_count: 0, 
    total_funded: 0  )
  file = open('https://quick-starter-dev.s3-us-west-1.amazonaws.com/chickens.jpeg')
  project4.photo.attach(io: file, filename: 'pool.jpg') # chicken 
  project4.save
  ...
  project5= Project.new(
    ...
    blurb: "TSA is more than just a government agency. Tighter flows than a leather jacket, just don't forget to take your shoes off when you go through the metal detector.",
  ...
  project6= Project.new(
    ...
    blurb: "After one episode of this show, watching paint dry will be your new love language. Guaranteed to help you appreciate good TV.",
    ...
    backer_count: 0, 
    total_funded: 0 )
  file = open('https://quick-starter-dev.s3-us-west-1.amazonaws.com/paintWall.jpeg')
  project6.photo.attach(io: file, filename: 'mountains.jpg')# paint cans
  project6.save
  ...
  project7= Project.new(
    ...
    blurb: "More than just pointy hats and long cloaks! Invisibility cloak not included, not that you could tell if it was!",
    ...
    backer_count: 0, 
    total_funded: 0 )
  file = open('https://quick-starter-dev.s3-us-west-1.amazonaws.com/wizard.jpeg')
  ...
  project8= Project.new(
    ...
    blurb: "Dog lovers need not apply, unless they're looking to become cat lovers. In which case, leave the puppy at home and come frolic with some felines!",
    ...
    backer_count: 0, 
    total_funded: 0 )
  file = open('https://quick-starter-dev.s3-us-west-1.amazonaws.com/cat.jpeg')
  ...
  project9= Project.new(
    ...
    blurb: "Notebooks are never out of style, but writing in your own notebook is so last season. Notes might be for nerds, but notebooks are for everyone! ",
    ...
    backer_count: 0, 
    total_funded: 0 )
  file = open('https://quick-starter-dev.s3-us-west-1.amazonaws.com/notebook.jpeg')
