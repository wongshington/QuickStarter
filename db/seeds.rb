...
project3= Project.create(title: "America's Next Top Child Artist", author_id: user2.id, funding_goal: 2110, funding_deadline: Date.new(2018, 10, 12), description: "Adult artists are so last year! Even Teenage artist can be too anxsty to really want to support. Everyone loves child art, well let's see who's finger-painting skills can take them to the next level! This one of a kind competition is coming to a pre-school near you. All we need is your support to help make your children into the stars that you all see them as. Why hang your child's art on your refirigerator when you can hang it in the Louvre! Support and Donate below!", category_id: cat1.id, title_image: "http://res.cloudinary.com/quickstarter/image/upload/c_scale,w_900/v1506312200/octavio-fossatti-37556_zgdbn9.jpg", backer_count: 0, total_funded: 0  )
